  ...
  return (
    <article className="container max-w-3xl py-12 sm:py-16">
      ...
      <section className="prose prose-slate mt-8 max-w-none dark:prose-invert">
        ...
        <h2 className="mt-10 text-2xl font-semibold">Use the service for sites you own or are authorized to test</h2>
        <p>
        ...
        <p>
          The service is provided &ldquo;as is.&rdquo; Scores are advisory; treat them as a
          starting point, not a verdict. We make no guarantees about availability or accuracy.
        </p>

        <h2 className="mt-8 text-2xl font-semibold">Rate limits</h2>
        <p>
          We rate-limit per-IP to keep the service free and reliable. If you need higher limits
          for legitimate use, reach out via <a href={siteConfig.links.github}>GitHub</a>.
        </p>
